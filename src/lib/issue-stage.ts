...
const legacyStageMap: Record<string, IssueStage> = {
  ...
  "qa-failed": "gd:fix",
  "qa-running": "gd:qa",
  "taskix:dev-running": "gd:dev",
  "taskix:architect-review": "gd:review",
  "taskix:need-qa": "gd:qa",
  "taskix:qa-running": "gd:qa",
  "taskix:qa-passed": "gd:review",
  "taskix:qa-failed": "gd:fix",
  "taskix:env-blocked": "gd:blocked",
  "taskix:spec-blocked": "gd:architect",
  "taskix:ready-to-merge": "gd:merge",
  "taskix:needs-rebase": "gd:rebase",
  "taskix:merged": "gd:done",
  "taskix:deployed": "gd:done",
  "taskix:blocked": "gd:blocked"
};
